...
def get_filename_from_url(url, fallback_name):
    ...
    If not found, it uses the fallback_name.
    """
    try:
...
def download_file(url, folder_path, file_name):
    ...
    try:
        ...
        # Log HTTP errors (4xx or 5xx) with the status code
...
def scrape_and_download_by_category():
    ...
    try:
        ...
        for file_info in file_list:
            ...
            # --- FIX FOR TYPE ERROR: Safely retrieve category, default to 'Uncategorized', and ensure it's a string ---
